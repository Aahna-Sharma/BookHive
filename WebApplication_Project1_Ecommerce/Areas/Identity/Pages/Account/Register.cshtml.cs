...
namespace WebApplication_Project1_Ecommerce.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                CompanyList = _unitOfWork.CompanyRepository.GetAll().Select(cl => new SelectListItem() {
                    Text = cl.Name,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // Assign company
                        if (Input.Role == SD.Role_Employee || Input.Role == SD.Role_Company)
                        {
                        ...
                        await _userManager.AddToRoleAsync(user,
                            string.IsNullOrEmpty(Input.Role) ? SD.Role_Individual : Input.Role);
                    }
